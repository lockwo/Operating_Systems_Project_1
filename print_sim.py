def end(fcfs: dict = None, sjf: dict = None, srt: dict = None, rr: dict = None):
    with open('simout.txt', 'w') as stats:
        ...
        # stats.write(f"-- average IO burst time: {fcfs['avg_io_burst']:.3f} ms\n")
        ...
        # stats.write(f"-- average IO burst time: {sjf['avg_io_burst']:.3f} ms\n")
        ...
        # stats.write(f"-- average IO burst time: {srt['avg_io_burst']:.3f} ms\n")
        ...
        # stats.write(f"-- average IO burst time: {rr['avg_io_burst']:.3f} ms\n")
