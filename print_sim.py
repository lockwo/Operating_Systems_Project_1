...
def end(fcfs, sjf, srt, rr):
    with open('simout.txt', 'w') as stats:
        ...
        stats.write(f"-- total number of context switches: {fcfs['context_switches']:.3f} ms\n")
        stats.write(f"-- total number of preemptions: {fcfs['preemptions']:.3f} ms\n")
        ...
        stats.write(f"-- total number of context switches: {sjf['context_switches']:.3f} ms\n")
        stats.write(f"-- total number of preemptions: {sjf['preemptions']:.3f} ms\n")
        ...
        stats.write(f"-- total number of context switches: {srt['context_switches']:.3f} ms\n")
        stats.write(f"-- total number of preemptions: {srt['preemptions']:.3f} ms\n")
        ...
        stats.write(f"-- total number of context switches: {rr['context_switches']:.3f} ms\n")
        stats.write(f"-- total number of preemptions: {rr['preemptions']:.3f} ms\n")
